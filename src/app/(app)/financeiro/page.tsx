...
import { findNavItem } from "@/lib/nav-registry"
...
const loadFinanceHubData = async () => {
  ...
  if (!onboardingDone) {
    ...
    redirect("/api/onboarding/complete?from=/financeiro")
  }
...
const FinanceiroPage = async () => {
  ...
  try {
    finance = await loadFinanceHubData()
  } catch (error) {
  ...
  return (
      <div className="space-y-6">
        ...
        {creditCards.length > 0 ? (
          <section
            className="dashboard-enter rounded-3xl border border-border/70 bg-surface p-5 shadow-[0_12px_34px_rgba(17,24,39,0.08)] dark:shadow-[0_16px_38px_rgba(2,6,23,0.46)] md:p-6"
          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <Link
                ...
                className="interactive-lift rounded-lg border border-border px-3 py-1.5 text-sm font-semibold transition hover:bg-slate-50 dark:hover:bg-slate-900/50"
              >
                Ver cartões
              </Link>
            </div>
        ...
        >
          <article className="panel interactive-lift p-5">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  {topGoals.map((goal) => {
                    ...
                    return (
                      <li
                        key={goal.id}
                        className="panel-soft rounded-xl px-3 py-2.5"
                      >
          ...
          <article className="rounded-2xl border border-amber-200/70 bg-amber-50/30 p-5 shadow-[0_10px_28px_rgba(251,191,36,0.18)] dark:border-amber-900/40 dark:bg-amber-950/20 lg:col-span-2 xl:col-span-1">
            <div>
            ...
            <Link
              href={`/financeiro/planejamento?year=${year}`}
              ...
              {upcomingItems.length === 0 ? (
                ...
                <ul className="space-y-2">
                  {upcomingItems.slice(0, 8).map((item) => (
                    <li
                      key={item.id}
                      className="panel-soft flex flex-wrap items-center justify-between gap-3 rounded-xl px-4 py-3"
                    >
          ...
          <aside className="space-y-4">
            ...
            <div className="panel p-5">
              ...
              <div className="mt-3 grid gap-2 sm:grid-cols-2">
                {[
                  { href: `/financeiro/planejamento?year=${year}`, hint: "Dívidas futuras" },
                  { href: "/financeiro/planejador", hint: "Estratégia de quitação" },
                  { href: "/financeiro/caixinhas", hint: "Metas e reserva" },
                  { href: "/financeiro/simulador", hint: "Teste um parcelamento" },
                  { href: "/financeiro/insights", hint: "Score e alertas" },
                  { href: "/financeiro/extrato", hint: "Lançamentos do mês" },
                  { href: "/pessoal/cadernos", hint: "Anotações e resumos" },
                  { href: "/financeiro/notificacoes", hint: "Vencimentos próximos" },
                ].map((action) => {
