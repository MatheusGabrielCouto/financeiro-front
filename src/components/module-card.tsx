...
export const ModuleCard = ({
  ...
  return (
    <article className={`panel interactive-lift p-5 ${className}`}>
      <div className="flex items-start justify-between gap-3">
        ...
        <Link
          ...
          className="interactive-lift shrink-0 rounded-lg border border-border px-3 py-1.5 text-sm font-semibold transition hover:bg-slate-50 dark:hover:bg-slate-900/50"
        >
          {actionLabel}
        </Link>
      </div>
